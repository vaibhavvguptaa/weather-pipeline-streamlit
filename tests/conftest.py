...
def invalid_config_kwargs():
    ...
    return {
        "invalid_latitude": {"latitude": 999.0, "longitude": 77.2090, "city_name": "Test",
                             "output_dir": "data", "db_name": "test.db",
                             "max_retries": 3, "retry_backoff": 2},
        "invalid_longitude": {"latitude": 28.6139, "longitude": 999.0, "city_name": "Test",
                              "output_dir": "data", "db_name": "test.db",
                              "max_retries": 3, "retry_backoff": 2},
        "empty_city": {"latitude": 28.6139, "longitude": 77.2090, "city_name": "",
                       "output_dir": "data", "db_name": "test.db",
                       "max_retries": 3, "retry_backoff": 2},
        "zero_retries": {"latitude": 28.6139, "longitude": 77.2090, "city_name": "Test",
                         "output_dir": "data", "db_name": "test.db",
                         "max_retries": 0, "retry_backoff": 2},
        "negative_backoff": {"latitude": 28.6139, "longitude": 77.2090, "city_name": "Test",
                             "output_dir": "data", "db_name": "test.db",
